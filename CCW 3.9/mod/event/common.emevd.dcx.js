...
$Event(0, Default, function() {
    ...
    // Start / Stranded Graveyard
    InitializeEvent(0, 20000, 30000000, 18002860, 18, 0, 0); // Ulcerated Tree Spirit - Fringefolk Hero's Grave (Stranded Graveyard)
    InitializeEvent(1, 20000, 30000001, 18002861, 18, 0, 0); // Soldier of Godrick - Stranded Graveyard
    InitializeEvent(2, 20000, 30000002, 10012691, 10, 1, 0); // Grafted Scion - Chapel of Anticipation
    
    // Limgrave
    InitializeEvent(4, 20000, 30000101, 30022841, 30, 2, 0); // Erdtree Burial Watchdog - Stormfoot Catacombs
    InitializeEvent(5, 20000, 30000102, 30042841, 30, 4, 0); // Grave Warden Duelist - Murkwater Catacombs
    InitializeEvent(6, 20000, 30000103, 30112841, 30, 11, 0); // Black Knife Assassin - Deathtouched Catacombs
    InitializeEvent(7, 20000, 30000104, 31002841, 31, 0, 0); // Patches - Murkwater Cave
    InitializeEvent(8, 20000, 30000105, 31152841, 31, 15, 0); // Demi-Human Chief - Coastal Cave
    InitializeEvent(9, 20000, 30000106, 31172841, 31, 17, 0); // Guardian Golem - Highroad Cave
    InitializeEvent(11, 20000, 30000108, 31032841, 31, 3, 0); // Beastman of Farum Azula - Groveside Cave
    InitializeEvent(12, 20000, 30000109, 32012841, 32, 1, 0); // Stonedigger Troll - Limgrave Tunnels
    InitializeEvent(13, 20000, 30000110, 1042362021, 60, 42, 36); // Tree Sentinel - Field Boss
    InitializeEvent(14, 20000, 30000111, 1042372820, 60, 42, 37); // Crucible Knight - Evergaol Boss
    InitializeEvent(15, 20001, 30000112, 1042382800, 60, 42, 38); // Deathbird - Night Boss
    InitializeEvent(16, 20001, 30000113, 1042382801, 60, 42, 38); // Bell-Bearing Hunter - Night Boss
    InitializeEvent(17, 20000, 30000114, 1043362801, 60, 43, 36); // Flying Dragon Agheel - Field Boss
    InitializeEvent(18, 20001, 30000115, 1043372340, 60, 43, 37); // Night's Cavalry - Night Boss
    InitializeEvent(19, 20000, 30000116, 1044352820, 60, 44, 35); // Bloodhound Knight Darriwil - Evergaol Boss
    InitializeEvent(20, 20000, 30000117, 1044362801, 60, 44, 36); // Mad Pumpkin Head - Waypoint Ruins
    InitializeEvent(206, 20000, 30000118, 1045392800, 60, 45, 39); // Tibia Mariner - Field Boss
    
    // Stormveil Castle
    InitializeEvent(21, 20000, 30000200, 10003901, 10, 0, 0); // Stormveil Castle: Margit, the Fell Omen
    InitializeEvent(22, 20000, 30000201, 10003902, 10, 0, 0); // Stormveil Castle: Godrick the Grafted
    
    // Weeping Penisula
    InitializeEvent(3, 20000, 30000100, 30002841, 30, 0, 0); // Cemetery Shade - Tombsward Catacombs
    InitializeEvent(10, 20000, 30000107, 31022841, 31, 2, 0); // Miranda the Blighted Bloom - Tombsward Cave
    InitializeEvent(23, 20000, 30000300, 30012841, 30, 1, 0); // Erdtree Burial Watchdog - Impaler's Catacombs
    InitializeEvent(24, 20000, 30000301, 31012841, 31, 1, 0); // Runebear - Earthbore Cave
    InitializeEvent(25, 20000, 30000302, 32002841, 32, 0, 0); // Scaly Misbegotten - Morne Tunnel
    InitializeEvent(26, 20000, 30000303, 1042332820, 60, 42, 33); // Ancient Hero of Zamor - Evergaol Boss
    InitializeEvent(27, 20000, 30000304, 1043302802, 60, 43, 30); // Leonine Misbegotten - Morne Moangrave
    InitializeEvent(28, 20000, 30000305, 1043332800, 60, 43, 33); // Erdtree Avatar - Field Boss
    InitializeEvent(29, 20001, 30000306, 1044322341, 60, 44, 32); // Deathbird - Night Boss
    InitializeEvent(30, 20001, 30000307, 1044322342, 60, 44, 32); // Night's Cavalry - Night Boss
    
    // Liurnia
    InitializeEvent(31, 20000, 30000400, 30032801, 30, 3, 0); // Spirit-Caller Snail - Road's End Catacombs
    InitializeEvent(32, 20000, 30000401, 30052841, 30, 5, 0); // Cemetery Shade - Black Knife Catacombs
    InitializeEvent(33, 20000, 30000402, 30052842, 30, 5, 0); // Black Knife Assassin - Black Knife Catacombs
    InitializeEvent(34, 20000, 30000403, 30062841, 30, 6, 0); // Erdtree Burial Watchdog - Cliffbottom Catacombs
    InitializeEvent(35, 20000, 30000404, 31042841, 31, 4, 0); // Cleanrot Knight - Stillwater Cave
    InitializeEvent(36, 20000, 30000405, 31062841, 31, 5, 0); // Bloodhound Knight - Lakeside Crystal Cave
    InitializeEvent(37, 20000, 30000406, 31062841, 31, 6, 0); // Crystalians (Spear and Staff) - Academy Crystal Cave
    InitializeEvent(38, 20000, 30000407, 32022841, 32, 2, 0); // Crystalian (Ringblade) - Raya Lucaria Crystal Tunnel
    InitializeEvent(39, 20000, 30000408, 39202730, 39, 20, 0); // Magma Wyrm Makar - Ruin-Strewn Precipice
    InitializeEvent(40, 20000, 30000409, 1033422820, 60, 33, 42); // Alecto, Black Knife Ringleader - Evergaol Boss
    InitializeEvent(41, 20000, 30000410, 1033452820, 60, 33, 45); // Bols, Carian Knight - Evergaol Boss
    InitializeEvent(42, 20000, 30000411, 1034422802, 60, 34, 42); // Glintstone Dragon Adula - Field Boss
    InitializeEvent(43, 20000, 30000412, 1034452801, 60, 34, 45); // Glintstone Dragon Smarag - Field Boss
    InitializeEvent(44, 20000, 30000413, 1034482621, 60, 34, 48); // Royal Revenant - Kingsrealm Ruins
    InitializeEvent(45, 20000, 30000414, 1035422801, 60, 35, 42); // Omenkiller - Albinauric Village
    InitializeEvent(46, 20000, 30000415, 1035502804, 60, 35, 50); // Royal Knight Loretta - Caria Manor
    InitializeEvent(47, 20000, 30000416, 1036502820, 60, 36, 50); // Alabaster Lord - Evergaol Boss
    InitializeEvent(48, 20001, 30000417, 1037462680, 60, 37, 46); // Bell-Bearing Hunter - Night Boss (Church of Vows)
    InitializeEvent(49, 20000, 30000418, 1038412820, 60, 38, 41); // Adan, Thief of Fire - Evergaol Boss
    InitializeEvent(50, 20000, 30000419, 1039442806, 60, 39, 44); // Tibia Mariner - Field Boss
    InitializeEvent(51, 20001, 30000420, 1036482340, 60, 36, 48); // Night's Cavalry (Bellum Highway) - Night Boss
    InitializeEvent(52, 20001, 30000421, 1039432340, 60, 39, 43); // Night's Cavalry (Liurnia Highway) - Night Boss
    InitializeEvent(53, 20001, 30000422, 1036452341, 60, 36, 45); // Death Rite Bird (Academy Gate Town) - Night Boss
    InitializeEvent(54, 20001, 30000423, 1037422341, 60, 37, 42); // Deathbird (Scenic Isle) - Night Boss
    InitializeEvent(55, 20000, 30000424, 1033432800, 60, 33, 43); // Erdtree Avatar (Southwest) - Field Boss
    InitializeEvent(56, 20000, 30000425, 1038482800, 60, 38, 48); // Erdtree Avatar (Northeast) - Field Boss
    
    // Academy of Raya Lucaria
    InitializeEvent(57, 20000, 30000500, 14002720, 14, 0, 0); // Rennala, Queen of the Full Moon
    InitializeEvent(58, 20000, 30000501, 14002721, 14, 0, 0); // Red Wolf of Radagon
    
    // Mt. Gelmir
    InitializeEvent(59, 20000, 30000600, 30092841, 30, 9, 0); // Red Wolf of the Champion (Gelmir Hero's Grave)
    InitializeEvent(60, 20000, 30000601, 30122841, 30, 12, 0); // Misbegotten Warrior + Perfumer Tricia (Unsightly Catacombs)
    InitializeEvent(61, 20000, 30000602, 31072841, 31, 7, 0); // Kindred of Rot (Seethewater Cave)
    InitializeEvent(62, 20000, 30000603, 31092841, 31, 9, 0); // Demi-Human Queen Margot (Volcano Cave)
    InitializeEvent(63, 20000, 30000604, 1035532800, 60, 35, 53); // Magma Wyrm - Field Boss
    InitializeEvent(64, 20000, 30000605, 1036542800, 60, 36, 54); // Full-Grown Fallingstar Beast - Field Boss
    InitializeEvent(65, 20000, 30000606, 1037532800, 60, 37, 53); // Demi-Human Queen Maggie - Field Boss
    InitializeEvent(66, 20000, 30000607, 1037542820, 60, 37, 54); // Ulcerated Tree Spirit - Field Boss
    
    // Volcano Manor
    InitializeEvent(67, 20000, 30000700, 16002570, 16, 0, 0); // Rykard, Lord of Blasphemy
    InitializeEvent(68, 20000, 30000701, 16002571, 16, 0, 0); // Godskin Noble
    InitializeEvent(69, 20000, 30000702, 16002572, 16, 0, 0); // Abductor Virgins
    
    // Altus Plateau
    InitializeEvent(70, 20000, 30000800, 30072841, 30, 7, 0); // Erdtree Burial Watchdog (Wyndham Catacombs)
    InitializeEvent(71, 20000, 30000801, 30082841, 30, 8, 0); // Ancient Hero of Zamor (Sainted Hero's Grave)
    InitializeEvent(72, 20000, 30000802, 30102841, 30, 10, 0); // Crucible Knight Ordovis (Auriza Hero's Grave)
    InitializeEvent(73, 20000, 30000803, 30132841, 30, 13, 0); // Grave Warden Duelist (Auriza Side Tomb)
    InitializeEvent(74, 20000, 30000804, 31182841, 31, 18, 0); // Miranda the Blighted Bloom (Perfumer's Grotto)
    InitializeEvent(75, 20000, 30000805, 31192841, 31, 19, 0); // Black Knife Assassin (Sage's Cave)
    InitializeEvent(76, 20000, 30000806, 1040522801, 60, 40, 52); // Black Knife Assassin (Sainted Hero's Grave Entrance)
    InitializeEvent(77, 20000, 30000807, 31192842, 31, 19, 0); // Necromancer Garris (Sage's Cave)
    InitializeEvent(78, 20000, 30000808, 32042841, 32, 4, 0); // Stonedigger Troll (Old Altus Tunnel)
    InitializeEvent(79, 20000, 30000809, 32052841, 32, 5, 0); // Crystalians (Spear and Ringblade)
    InitializeEvent(80, 20000, 30000810, 34122841, 34, 12, 0); // Onyx Lord (Divine Tower of West Altus)
    InitializeEvent(81, 20000, 30000811, 1037512800, 60, 37, 51); // Ancient Dragon Lansseax - Field Boss
    InitializeEvent(82, 20000, 30000812, 1038512801, 60, 38, 51); // Demi-Human Queen Gilka (Lux Ruins)
    InitializeEvent(83, 20000, 30000813, 1038522350, 60, 38, 52); // Tibia Mariner (Wyndham Ruins) - Field Boss
    InitializeEvent(84, 20000, 30000814, 1039502820, 60, 39, 50); // Godefroy the Grafted - Evergaol Boss
    InitializeEvent(85, 20001, 30000815, 1039512800, 60, 39, 51); // Night's Cavalry - Night Boss
    InitializeEvent(86, 20000, 30000816, 1039542820, 60, 39, 54); // Elemer of the Briar (Shaded Castle)
    InitializeEvent(87, 20000, 30000817, 1040532720, 60, 40, 53); // Sanguine Noble (Writheblood Ruins)
    InitializeEvent(88, 20000, 30000818, 1041502800, 60, 41, 50); // Fallingstar Beast - Field Boss
    InitializeEvent(89, 20000, 30000819, 1041512750, 60, 41, 51); // Tree Sentinel Duo - Field Boss
    InitializeEvent(90, 20000, 30000820, 1041532800, 60, 41, 53); // Wormface (Moonfolk Ruins) - Field Boss
    InitializeEvent(91, 20000, 30000821, 1042552800, 60, 42, 55); // Godskin Apostle - Field Boss
    
    // Caelid
    InitializeEvent(92, 20000, 30000900, 1051372800, 60, 51, 37); // Starscourge Radahn
    InitializeEvent(93, 20000, 30000901, 30142850, 30, 14, 0); // Erdtree Burial Watchdog (Minor Erdtree Catacombs)
    InitializeEvent(94, 20000, 30000902, 30152850, 30, 15, 0); // Cemetery Shade (Caelid Catacombs)
    InitializeEvent(98, 20000, 30000906, 31212850, 31, 21, 0); // Frenzied Duelist (Gaol Cave)
    InitializeEvent(99, 20000, 30000907, 32072850, 32, 7, 0); // Magma Wyrm (Gael Tunnel)
    InitializeEvent(100, 20000, 30000908, 32082850, 32, 8, 0); // Fallingstar Beast (Sellia Crystal Tunnel)
    InitializeEvent(102, 20000, 30000910, 1048372850, 60, 48, 37); // Decaying Ekzykes - Field Boss
    InitializeEvent(103, 20000, 30000911, 1048402850, 60, 48, 40); // Mad Pumpkin Head (Duo) (Caelem Ruins)
    InitializeEvent(105, 20001, 30000913, 1049372850, 60, 49, 37); // Death Rite Bird - Night Boss
    InitializeEvent(106, 20000, 30000914, 1049382850, 60, 49, 38); // Commander O'Neil - Field Boss
    InitializeEvent(107, 20000, 30000915, 1049392870, 60, 49, 39); // Nox Priest and Swordstress (Sellia)
    InitializeEvent(109, 20000, 30000917, 1051362850, 60, 51, 36); // Crucible Knight (Redmane Castle)
    InitializeEvent(112, 20001, 30000920, 1049372851, 60, 49, 37); // Night's Cavalry (Swamp of Aeonia) - Night Boss
    InitializeEvent(114, 20000, 30000922, 30162850, 30, 16, 0); // Putrid Tree Spirit - War-Dead Catacombs
    InitializeEvent(116, 20000, 30000924, 1047402850, 60, 47, 40); // Putrid Avatar (Caelid) - Field Boss
    
    // Dragonbarrow
    InitializeEvent(95, 20000, 30000903, 31102850, 31, 10, 0); // Beastman of Farum Azula (Duo) (Dragonbarrow Cave)
    InitializeEvent(96, 20000, 30000904, 31112850, 31, 11, 0); // Putrid Crystalians (Spear and Ringblade) (Sellia Hideaway)
    InitializeEvent(97, 20000, 30000905, 31202850, 31, 20, 0); // Cleanrot Knight (Duo) (Abandoned Cave)
    InitializeEvent(101, 20000, 30000909, 34132850, 34, 13, 0); // Godskin Apostle (Divine Tower of Caelid)
    InitializeEvent(104, 20001, 30000912, 1048412850, 60, 48, 41); // Bell-Bearing Hunter (Isolated Merchant's Shack) - Night Boss
    InitializeEvent(108, 20000, 30000916, 1049392871, 60, 49, 39); // Battlemage Hugues - Evergaol Boss
    InitializeEvent(110, 20000, 30000918, 1051432850, 60, 51, 43); // Black Blade Kindred - Field Boss
    InitializeEvent(111, 20000, 30000919, 1052412850, 60, 52, 41); // Flying Dragon Greyll - Field Boss
    InitializeEvent(113, 20001, 30000921, 1052422850, 60, 52, 42); // Night's Cavalry (Dragonbarrow) - Night Boss
    InitializeEvent(115, 20000, 30000923, 1051402850, 60, 51, 40); // Putrid Avatar (Dragonbarrow) - Field Boss
    
    // Capital Outskirts
    InitializeEvent(117, 20000, 30001000, 34142860, 34, 14, 0); // Fell Twins
    InitializeEvent(118, 20001, 30001001, 1043532850, 60, 43, 53); // Bell-Bearing Hunter (Hermit Merchant's Shack) - Night Boss
    InitializeEvent(119, 20001, 30001002, 1044532850, 60, 44, 53); // Death Rite Bird - Night Boss
    InitializeEvent(120, 20000, 30001003, 1045522850, 60, 45, 52); // Draconic Tree Sentinel - Field Boss
    
    // Leyndell, Royal Capital
    InitializeEvent(121, 20000, 30001100, 11002860, 11, 0, 0); // Godfrey, First Elden Lord
    InitializeEvent(122, 20000, 30001101, 11002861, 11, 0, 0); // Morgott, the Omen King
    
    // Subterranean Shunning-Grounds
    InitializeEvent(123, 20000, 30001102, 35002860, 35, 0, 0); // Mohg, The Omen
    InitializeEvent(124, 20000, 30001103, 35002861, 35, 0, 0); // Esgar, Priest of Blood
    
    // Leyndell, Ashen Capital
    InitializeEvent(153, 20000, 30002000, 11052690, 11, 5, 0); // Godfrey / Hoarah Loux
    InitializeEvent(154, 20000, 30002001, 11052691, 11, 5, 0); // Sir Gideon Ofnir
    
    // Siofra River
    InitializeEvent(126, 20000, 30001201, 12022861, 12, 2, 0); // Dragonkin Soldier
    InitializeEvent(127, 20000, 30001202, 12082850, 12, 8, 0); // Ancestor Spirit
    
    // Ainsel River
    InitializeEvent(128, 20000, 30001300, 12012850, 12, 1, 0); // Dragonkin Soldier of Nokstella
    
    // Lake of Rot
    InitializeEvent(129, 20000, 30001400, 12012851, 12, 1, 0); // Dragonkin Soldier
    InitializeEvent(130, 20000, 30001401, 12042850, 12, 4, 0); // Astel, Naturalborn of the Void
    
    // Deeproot Depths
    InitializeEvent(131, 20000, 30001500, 12032850, 12, 3, 0); // Crucible Knight Sirulia
    InitializeEvent(132, 20000, 30001501, 12032851, 12, 3, 0); // Fia's Champions
    InitializeEvent(133, 20000, 30001502, 12032851, 12, 3, 0); // Lichdragon Fortissax
    
    // Mohgwyn Palace
    InitializeEvent(134, 20000, 30001600, 12052850, 12, 5, 0); // Mohg, Lord of Blood
    
    // Nokron, Eternal City
    InitializeEvent(125, 20000, 30001200, 12022860, 12, 2, 0); // Valiant Gargoyles
    InitializeEvent(135, 20000, 30001700, 12092850, 12, 9, 0); // Regal Ancestor Spirit
    InitializeEvent(136, 20000, 30001701, 12022862, 12, 2, 0); // Mimic Tear
    
    // Consecrated Snowfield
    InitializeEvent(137, 20000, 30001800, 30192850, 30, 19, 0); // Putrid Grave Warden Duelist (Consecrated Snowfield Catacombs)
    InitializeEvent(138, 20000, 30001801, 32112850, 32, 11, 0); // Astel, Stars of Darkness (Yelough Anix Tunnel)
    InitializeEvent(139, 20001, 30001802, 1048572850, 60, 48, 57); // Death Rite Bird - Night Boss
    InitializeEvent(140, 20000, 30001803, 1050572850, 60, 50, 57); // Putrid Avatar - Field Boss
    InitializeEvent(141, 20001, 30001804, 1048552850, 60, 48, 55); // Night's Cavalry (Duo) - Night Boss
    
    // Mountaintops of the Giants
    InitializeEvent(142, 20000, 30001900, 1052522850, 60, 52, 53); // Fire Giant
    InitializeEvent(143, 20000, 30001901, 30172850, 30, 17, 0); // Ancient Hero of Zamor (Giant-Conquering Hero's Grave)
    InitializeEvent(144, 20000, 30001902, 30182850, 30, 18, 0); // Ulcerated Tree Sprit (Giants' Mountaintop Catacombs)
    InitializeEvent(145, 20000, 30001903, 31122850, 31, 12, 0); // Misbegotten Crusader (Cave of the Forlonr)
    InitializeEvent(146, 20000, 30001904, 31222850, 31, 22, 0); // Spirit-Caller Snail (Spiritcaller Cave)
    InitializeEvent(147, 20000, 30001906, 1050562850, 60, 50, 56); // Great Wyrm Theodorix - Field Boss
    InitializeEvent(148, 20001, 30001907, 1050572851, 60, 50, 57); // Death Rite Bird - Night Boss
    InitializeEvent(149, 20000, 30001908, 1051572850, 60, 51, 57); // Commander Niall (Castle Sol)
    InitializeEvent(150, 20000, 30001909, 1052562850, 60, 52, 56); // Erdtree Avatar - Field Boss
    InitializeEvent(151, 20000, 30001910, 1053562850, 60, 53, 56); // Roundtable Knight Vyke
    InitializeEvent(152, 20000, 30001911, 1054562850, 60, 54, 56); // Borealis the Freezing Fog
    
    // Crumbling Farum Azula
    InitializeEvent(155, 20000, 30002100, 13002860, 13, 0, 0); // Maliketh, The Black Blade
    InitializeEvent(156, 20000, 30002101, 13002861, 13, 0, 0); // Dragonlord Placidusax
    InitializeEvent(157, 20000, 30002102, 13002862, 13, 0, 0); // Godskin Duo
    
    // Miquella's Haligtree
    InitializeEvent(158, 20000, 30002200, 15002870, 15, 0, 0); // Malenia, Blade of Miquella
    InitializeEvent(159, 20000, 30002201, 15002871, 15, 0, 0); // Loretta, Knight of the Haligtree
    
    // Forbidden Lands
    InitializeEvent(160, 20000, 30002300, 30202850, 30, 20, 0); // Stray Mimic Tear
    InitializeEvent(161, 20000, 30002301, 1049522850, 60, 49, 52); // Black Blade Kindred - Field Boss
    InitializeEvent(162, 20001, 30002302, 1048512850, 60, 48, 51); // Night's Cavalry - Night Boss
    
    // Elden Throne
    InitializeEvent(163, 20000, 30002400, 19002850, 19, 0, 0); // Radagon and the Elden Beast
    
    // Gravesite Plain
    InitializeEvent(164, 20000, 30002500, 2046412850, 61, 46, 41); // Blackgaol Knight (Western Nameless Mausoleum)
    InitializeEvent(165, 20000, 30002501, 43002850, 43, 0, 0); // Chief Bloodfiend (Rivermouth Cave)
    InitializeEvent(166, 20000, 30002502, 41002850, 41, 0, 0); // Demi-Human Swordmaster Onze (Belurat Gaol)
    InitializeEvent(167, 20000, 30002503, 20002850, 20, 0, 0); // Divine Beast Dancing Lion (Belurat, Tower Settlement)
    InitializeEvent(168, 20000, 30002504, 2045442850, 61, 45, 44); // Ghostflame Dragon - Field Boss
    InitializeEvent(169, 20000, 30002505, 41022891, 41, 2, 0); // Lamenter (Lamenter's Gaol)
    InitializeEvent(170, 20000, 30002506, 2048442850, 61, 48, 44); // Rellana Twin Moon Knight (Castle Ensis)
    InitializeEvent(171, 20000, 30002507, 2046452850, 61, 46, 45); // Red Bear (Northern Nameless Mausoleum)
    
    // Scadu Altus
    InitializeEvent(172, 20000, 30002600, 2049432860, 61, 49, 43); // Black Knight Edreed
    InitializeEvent(173, 20000, 30002601, 2047452850, 61, 47, 45); // Black Knight Garrew
    InitializeEvent(174, 20000, 30002602, 2049482850, 61, 49, 48); // Commander Gaius
    InitializeEvent(175, 20000, 30002603, 2051452850, 61, 51, 45); // Count Ymir, Mother of Fingers
    InitializeEvent(176, 20000, 30002604, 41012850, 41, 1, 0); // Curseblade Labirith (Bonny Gaol)
    InitializeEvent(177, 20000, 30002605, 40002850, 40, 0, 0); // Death Knight (Fogrift Catacombs)
    InitializeEvent(178, 20000, 30002606, 2049442850, 61, 49, 44); // Dryleaf Dane - Field Boss
    InitializeEvent(179, 20000, 30002607, 2049432861, 61, 49, 43); // Ghostflame Dragon - Field Boss
    InitializeEvent(180, 20000, 30002608, 21002860, 21, 0, 0); // Golden Hippopotamus
    InitializeEvent(181, 20000, 30002609, 21012850, 21, 1, 0); // Messmer the Impaler
    InitializeEvent(182, 20000, 30002610, 2051452851, 61, 51, 45); // Metyr, Mother of Fingers
    InitializeEvent(183, 20000, 30002611, 2051442850, 61, 51, 44); // Rakshasa (Eastern Nameless Mausoleum)
    InitializeEvent(184, 20000, 30002612, 2049452850, 61, 49, 45); // Ralva the Great Red Bear - Field Boss
    InitializeEvent(185, 20000, 30002613, 2050472850, 61, 50, 47); // Tree Sentinel - Field Boss
    
    // Rauh Base
    InitializeEvent(186, 20000, 30002700, 40010850, 40, 1, 0); // Death Knight
    InitializeEvent(187, 20000, 30002701, 2046462750, 61, 46, 46); // Divine Beast Dancing Lion
    InitializeEvent(188, 20000, 30002702, 2044452850, 61, 44, 45); // Romina, Saint of the Bud
    InitializeEvent(189, 20000, 30002703, 2044472850, 61, 44, 47); // Rugalea the Great Red Bear
    
    // Cerulean Coast
    InitializeEvent(190, 20000, 30002800, 2046382850, 61, 46, 38); // Dancer of Ranah
    InitializeEvent(191, 20000, 30002801, 2048382860, 61, 48, 38); // Ghostflame Dragon
    InitializeEvent(192, 20000, 30002802, 22002850, 22, 0, 0); // Putrescent Knight
    
    // Charo's Hidden Grave
    InitializeEvent(193, 20000, 30002900, 2047392850, 61, 47, 39); // Death Rite Bird
    InitializeEvent(194, 20000, 30002901, 2046402850, 61, 46, 40); // Demi-Human Queen Marigga
    
    // Jagged Peak
    InitializeEvent(195, 20000, 30003000, 43012850, 43, 1, 0); // Ancient Dragon-Man
    InitializeEvent(196, 20000, 30003001, 2054392860, 61, 54, 39); // Ancient Dragon Senessax
    InitializeEvent(197, 20000, 30003002, 2054392861, 61, 54, 39); // Bayle the Dread
    InitializeEvent(198, 20000, 30003003, 2052402850, 61, 52, 40); // Jagged Peak Drake
    
    // Abyssal Woods
    InitializeEvent(199, 20000, 30003100, 2052432850, 40, 2, 0); // Jori, Elder Inquisitor
    InitializeEvent(200, 20000, 30003101, 28002850, 28, 0, 0); // Midra Lord of Frenzied Flame
    
    // Scaduview
    InitializeEvent(201, 20000, 30003200, 2052482850, 61, 52, 48); // Fallingstar Beast
    InitializeEvent(202, 20000, 30003201, 2050482850, 61, 50, 48); // Scadutree Avatar
    InitializeEvent(203, 20000, 30003202, 2050482860, 61, 50, 48); // Tree Sentinel
    
    // Enir-Ilim
    InitializeEvent(204, 20000, 30003300, 20012860, 20, 1, 0); // Promised Consort Radahn
    
    // Finger Ruins Rhia
    InitializeEvent(205, 20000, 30003400, 2049412850, 61, 49, 41); // Jagged Peak Drake
});

// Teleport
$Event(20000, Default, function(X0_4, X4_4, X8_1, X12_1, X16_1) {
    WaitFor(CharacterHasSpEffect(10000, X0_4, Equal, 1));
    WarpPlayer(X8_1, X12_1, X16_1, 0, X4_4, -1);
});

// Teleport (Set to Night)
$Event(20001, Default, function(X0_4, X4_4, X8_1, X12_1, X16_1) {
    WaitFor(CharacterHasSpEffect(10000, X0_4, Equal, 1));
