...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 31172999, 0); // NEW
});
...
$Event(31172810, Restart, function() { // NEW
...
L2:
    ...
    DisplayBossHealthBar(Enabled, 31170800, 0, 903970310);
...
$Event(31172999, Restart, function() { // NEW
    WaitFor(CharacterHasSpEffect(31170800, 14655));
    ShootBullet(31170800, 1031170972, -1, 239700516, 0, 0, 0);
    WaitFixedTimeSeconds(3.5)
    ShootBullet(31170800, 1031170972, -1, 239700514, 0, 0, 0);
